...
#define UART0                           UART0_BASE /* APB0 */
#define UART1                           UART1_BASE  /* APB0 */
#define UART2                           UART2_BASE /* APB1 */
#define UART3                           UART3_BASE /* APB1 */
...
#define UART_TER(port)                  MMIO32((port) + 0x030)
...
#define UART_LCR_BITMASK                ((uint8_t)(0x7F))
...
#define UART_TER_TXEN                   (1 << 7)    /* Transmit enable bit */
